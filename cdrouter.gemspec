...
Gem::Specification.new do |s|
  ...
  s.files       = ["lib/cdrouter.rb", "lib/cdrouter/version.rb", "lib/cdrouter/session.rb", "lib/cdrouter/package.rb", "lib/cdrouter/config.rb", "lib/cdrouter/result.rb", "lib/cdrouter/history.rb", "lib/cdrouter/user.rb"]
